      ...
      <template v-slot:subheader>
        <div class="header-nav-wrap">
          <div class="row align-items-center">
            ...
            <div class="col-auto">
              <h5 class="fw-bold">{{ $t('Tax Returned Report') }}</h5>
            </div>
          </div>
        </div>
      </template>
                ...
                <div class="row field-m-0 align-items-end g-3">
                    <div class="col-md-4 col-lg-3">
                        <div class="form-field ">
                            <label class="form-label">{{ $t('Select Dates') }} <span class="text-danger">*</span> </label>
...
async function exportExcel(){
    ...
    await axios.get('/api/tax_returned_report/export_excel', { params : {
            filter: filter,
    }}).then( (response) => {
