      ...
      <div class="header-nav-wrap">
        <div class="row align-items-center">
          ...
          <div class="col-auto">
            ...
            <h5 class="fw-bold" v-else>{{ $t("Edit Voucher User") }}</h5>
          </div>
        </div>
      </div>
    </template>
...
async function getVoucherUser() {
  ...
  if (response.data.data) {
    form.voucher_user_slack = response.data.data.slack;
...
async function saveVoucherUser() {
  ...
  form_data.append("slack", form.voucher_user_slack);
  var submit_url =
      form.voucher_user_slack != "" && form.voucher_user_slack != undefined
