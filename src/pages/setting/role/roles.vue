      ...
      <div class="page-heading">
        <div class="row align-items-center justify-content-end">
          ...
          <div class="col-auto" v-if="permissions.write">
              <a href="#" class="btn btn-sm btn-light-primary2" data-bs-toggle="modal" @click="openAddRoleModal()" data-bs-target="#addRoleModal">+ {{ $t('New Role') }}</a>
          </div>
        </div>
        <div class="row">
...
async function getRoles(page = 1){
  ...
  await axios.get('/api/v2/roles', { params : {
      page : page,
