        ...
        <table class="table table-list-data table-hover">
          <thead class="bg-light">
            <tr>
              ...
              <th scope="col" width="10%">{{ $t("Role") }}</th>
              <th scope="col" width="10%">{{ $t("Multi-Device Login") }}</th>
              <th scope="col" width="10%">
                {{ $t("Allow Adding Merchants") }}
              </th>
          ...
          <tbody>
            ...
            >
              ...
              <td @click="viewUser(user.slack)" role="button">
                <Icon
                  v-if="user.allow_adding_merchants"
                  :style="{ fontSize: '20px' }"
                  class="text-success"
                  icon="material-symbols:check"
                />
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-auto">
            <Bootstrap5Pagination
              :data="pagination"
              :limit="5"
              @pagination-change-page="getSubAdmins"
            />
          </div>
        </div>
      </div>
...
async function changeStatus(slack) {
  ...
  await axios
    .post("/api/sub_admin/update_status", form_data)
    .then((response) => {
