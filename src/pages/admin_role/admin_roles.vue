            ...
            <div class="page-heading">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="row align-items-center">
                            <div class="col-auto" >
                                <a class="btn btn-sm btn-light-primary"  data-bs-toggle="modal" @click="openAddRoleModal()" data-bs-target="#addRoleModal">+ {{ $t('New Role') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-auto">
...
const AsyncAddRole = defineAsyncComponent( () => import('@/components/role/AddAdminRole.vue') );
...
async function getRoles(page = 1){
  ...
  await axios.get('/api/admin/roles', { params : {
      page : page,
...
async function changeStatus(slack){
  ...
  await axios.post('/api/admin/role/update_status', form_data).then( (response) => {
...
async function deleteRole(slack){
  ...
  if(is_confirmed){
    ...
    await axios.post('/api/admin/role/delete',{
      slack : slack
    }).then( (response) => {
