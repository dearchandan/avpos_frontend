                ...
                <div class="row align-items-center">
                    <div class="col-auto">
                        <div class="header-back-link">
                          <router-link class="text-primary" to="/transactions" ><Icon icon="fa6-solid:chevron-left"  /> {{ $t('Transactions') }}</router-link>                        </div>
                    </div>
                    <div class="col-auto">
...
async function saveTransaction(){
    ...
    await axios.post('/api/transaction/save', form_data).then( (response) => {
