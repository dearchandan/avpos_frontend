            ...
            <div class="col-md-5">
                <div class="login-page-wrap">
                    ...
                    <div class="card login-card">
                        ...
                        <p class=" pt-4 text-center login-link-text"><router-link to="/"><b> {{ $t("Back to sign in") }}</b></router-link></p>

                    </div>

                    <div class="row">
                        <div class="pt-5 copyright-text text-center">
                ...
                <div class="col-lg-7">
                    <div class="login-leftbar">
                        <div class="inner">
                            ...
                            <h5>More than <b>+8,000</b> businesses manage their operations effectively and makes it easy for you to track all aspects of your business.</h5>
...
<script setup>
    ...
    const schema = yup.object({
        email: yup.string().required(t("name is required", { name: t("merchant email") })).email(t('must be a valid email', { name: t('merchant email') })),
    });
    ...
    async function forgotPassword(){
        ...
        await axios.post('/api/forgot_password', form_data ).then( (response) => {
