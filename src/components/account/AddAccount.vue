<template>
   <div class="modal hide" id="addAccountModal"  tabindex="-1" aria-labelledby="Add Account" aria-modal="true" role="dialog"  data-bs-backdrop="static" data-bs-keyboard="false"> 
...
<script setup>
    ...
    async function saveAccount(){
        ...
        var submit_url = (form.account_slack != '' && form.account_slack!= undefined)?'/api/account/update':'/api/account/save';
