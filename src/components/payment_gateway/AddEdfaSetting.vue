            ...
            <div class="row mb-3">
              <div class="col-12">
                <ul class="pb-2 mb-2 border-bottom">
                  <li class="text-danger"><b>{{labels.edfa_note1}}</b></li>
                  <li class="text-danger"><b>{{labels.edfa_note2}}</b></li>
                </ul>
              </div>
              <div class="col-12">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <div class="col-4">
                    <label class="label"> {{ $t('Password') }}<span class="text-danger">*</span></label>
                  </div>
                  <div class="col-8">
                    <VTextInput
                        type="text"
...
let schema = yup.object().shape({
    ...
    password: yup.string().required(t('name is required', { name: t('Password') })),
});
