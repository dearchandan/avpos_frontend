<template>
    <div class="modal hide" id="addCustomerCustomFieldModal"  tabindex="-1" aria-labelledby="Add Custom Field" aria-modal="true" role="dialog"  data-bs-backdrop="static" data-bs-keyboard="false">
 ...
 <script setup>
    ...
    const labels = ref({
     ...
     const props = defineProps(['show_add_customer_custom_field_modal','customer_slack','edit_data']);
     ...
     async function saveCustomField(){
         ...
         form_data.append('customer_slack',props.customer_slack);
         ...
         var submit_url = (form.custom_field_slack != '')?'/api/customer/custom_field/update':'/api/customer/custom_field/save';
