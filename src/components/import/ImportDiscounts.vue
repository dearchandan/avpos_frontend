...
<div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <a :href="export_discount_template" class="btn btn-link" download>
...
import useDiscountExportTemplate from '@/composables/export_discounts_template.js';

const { export_discount_template } = useDiscountExportTemplate();
...
async function submit(e){
    ...
    await Swal.fire({
        ...
        title: 'Warning!',
        text: 'Are you sure about import the discounts?',
        icon: 'warning',
    ...
    if(is_confirmed){
        ...
        await axios.post('/api/import/discounts',form_data, {
          headers: {
