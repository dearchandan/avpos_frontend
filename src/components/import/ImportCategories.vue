<template>
    <div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <a :href="export_category_template" class="btn btn-link" download>
...
import useCategoryExportTemplate from '@/composables/export_categories_template.js';

const { export_category_template } = useCategoryExportTemplate();
...
async function submit(e){
    ...
    await Swal.fire({
        ...
        title: 'Warning!',
        text: 'Are you sure about import the categories?',
        icon: 'warning',
    ...
    if(is_confirmed){
        ...
        await axios.post('/api/import/categories',form_data, {
          headers: {
