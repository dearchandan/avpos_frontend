...
<div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <a :href="export_product_template" class="btn btn-link" download>
...
import useProductExportTemplate from '@/composables/export_products_template.js';

const { export_product_template } = useProductExportTemplate();
...
async function submit(e){
    ...
    await Swal.fire({
        ...
        title: 'Warning!',
        text: 'Are you sure about import the products?',
        icon: 'warning',
    ...
    if(is_confirmed){
        ...
        await axios.post('/api/import/products',form_data, {
          headers: {
