...
<div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <a :href="export_customer_template" class="btn btn-link" download>
...
import useCustomerExportTemplate from '@/composables/export_customers_template.js';

const { export_customer_template } = useCustomerExportTemplate();
...
async function submit(e){
    ...
    await Swal.fire({
        ...
        title: 'Warning!',
        text: 'Are you sure about import the customers?',
        icon: 'warning',
    ...
    if(is_confirmed){
        ...
        await axios.post('/api/import/customers',form_data, {
          headers: {
