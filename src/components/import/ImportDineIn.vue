...
<div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <a :href="export_dine_in_template" class="btn btn-link" download>
...
import useDineInExportTemplate from '@/composables/export_dine_in_template.js';

const { export_dine_in_template } = useDineInExportTemplate();
...
async function submit(e){
    ...
    await Swal.fire({
        ...
        title: 'Warning!',
        text: 'Are you sure about import the dine-in Tables data?',
        icon: 'warning',
    ...
    if(is_confirmed){
        ...
        await axios.post('/api/import/dine_in_tables',form_data, {
          headers: {
