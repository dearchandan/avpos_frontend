<template>
    <div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto">
            <a :href="export_ingredient_template" class="btn btn-link" download>
...
import useIngredientExportTemplate from '@/composables/export_ingredients_template.js';

const { export_ingredient_template } = useIngredientExportTemplate();
...
async function submit(e){
    ...
    await Swal.fire({
        ...
        title: 'Warning!',
        text: 'Are you sure about import the ingredients?',
        icon: 'warning',
    ...
    if(is_confirmed){
        ...
        await axios.post('/api/import/ingredients',form_data, {
          headers: {
