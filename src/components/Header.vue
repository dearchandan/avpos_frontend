      ...
      <div class="col-auto">
        <div class="row align-items-center gx-2 gx-md-3">
          ...
          <div class="col-auto ms-2" v-if="user_type != 1 && user_type != 4">
            <button
              type="button"
              class="h-cashier-btn btn"
              @click=" my_branches && my_branches.length > 1 ? openBranchSwitcher() : ''"
              :class="{ 'btn-light' : my_branches && my_branches.length > 1 }"
            >
              <svg
                class=""
                width="20"
      ...
      <div class="col-auto">
        <div class="row align-items-center">
          ...
          <div class="col-auto" v-if="user_type == 1 || user_type == 4">
            <span
              type="button"
              class="h-cashier-btn btn  border border-0"
              v-if="user_type == 1"
            >
